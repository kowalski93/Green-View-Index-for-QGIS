...
#		begin				: 2023-04-21
#		git sha				: $Format:%H$
#		copyright			: (C) 2023 by Alexandros
#		email				: Voukenas
# ***************************************************************************/
#
#/***************************************************************************
...
QGISDIR=C:\Users\alexandros.voukenas\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
